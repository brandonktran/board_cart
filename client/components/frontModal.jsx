    ...
    return (
      <div className="background-modal position-fixed d-flex h-100 w-100" >
        <div className="modal-contents m-auto bg-white border rounded mt-5 p-3">
          <h2 className="m-2">Welcome to Cinemago!</h2>
          <hr></hr>
          ...
          <form onSubmit={event => {
            ...
            <div className="form-check m-2">
              ...
              <label className="form-check-label" htmlFor="acknowledgement">I acknowledge the statement above.</label>
            </div>
            <div className="btn-group w-100 p-1">
              <button className="btn btn-danger w-100">Let's Shop!</button>
            </div>
          </form>
        </div>
      </div>
