  ...
  render() {
    return (
      <div className="col-md-4 py-2">
        <div className="card m-2 h-100 shadow border-light" style={{ cursor: 'pointer' }} onClick={() => { this.props.setView('details', { productId: this.props.card.productId, type: this.props.category }); }}>
